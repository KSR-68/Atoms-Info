...
export const ElementSidebar = ({ element, onClose }: ElementSidebarProps) => {
  ...
  return (
    <div className="sidebar-overlay" onClick={onClose}>
      <div className="element-sidebar" onClick={(e) => e.stopPropagation()}>
        <button className="close-button" onClick={onClose}>
          ×
        </button>

        <div className="sidebar-header" style={{ backgroundColor }}>
          <span className="sidebar-atomic-number">{element.atomicNumber}</span>
          <span className="sidebar-symbol">{element.symbol}</span>
          <span className="sidebar-name">{element.name}</span>
        </div>
